  ...
  .DESCRIPTION
  This script will added and verify a domain in Office 365 and the necessary DNS records to Azure DNS 
  ...
  All parameters are required for the script to complete successfully. 
...
{
Write-Host -ForegroundColor Yellow "Unable to verify domain, the script will continue adding records but you will have to verify domain from the Office 365 portal after the script is done."
}
...
Write-Host -ForegroundColor Green "Process Completed.... Domain added and verified on Office 365, DNS records for Office 365 added to Azure DNS"
Stop-Transcript
}
...
#Validate NS record has been set on Domain Registrar 
...
#Process function if NS record is validated
ProcessDomain